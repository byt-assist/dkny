...
(function() {
    // Ключи для хранения
    const STORAGE_KEYS = {
        counter: 'dkny_counter',
        visitors: 'dkny_visitors',
        clients: 'dkny_clients',
        startTime: 'dkny_start_time',
        lastUpdate: 'dkny_last_update',
        counterHash: 'dkny_counter_hash'
    };

    // Соль для хеша
    const SALT = 'dkny_salt_2026_secure';
    ...
    function updateMetadata(visitors, clients, startTime) {
        ...
        script.textContent = JSON.stringify({
            ...
            "@type": "WebSite",
            "name": "DKNY Token",
            "description": "DKNY is the flagship token of the BYT ecosystem with RWA integration.",
            "statistics": {
                "visitors": visitors,
                "clients": clients,
